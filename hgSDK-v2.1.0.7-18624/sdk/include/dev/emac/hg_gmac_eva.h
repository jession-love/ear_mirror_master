 ...
 */
    ...
    #define HG_GMAC_MDIO_SET_OUTPUT(p_gmac)     (gpio_ioctl(p_gmac->mdio_pin, GPIO_DIR_ATOMIC, GPIO_DIR_OUTPUT, 0))
    #define HG_GMAC_MDIO_SET_INPUT(p_gmac)      (gpio_ioctl(p_gmac->mdio_pin, GPIO_DIR_ATOMIC, GPIO_DIR_INPUT, 0))
    #define HG_GMAC_MDIO_HIGH(p_gmac)           (gpio_ioctl(p_gmac->mdio_pin, GPIO_VALUE_ATOMIC, 1, 0))
    #define HG_GMAC_MDIO_LOW(p_gmac)            (gpio_ioctl(p_gmac->mdio_pin, GPIO_VALUE_ATOMIC, 0, 0))
    #define HG_GMAC_MDIO_GET(p_gmac)            (gpio_get_val(p_gmac->mdio_pin))
    #define HG_GMAC_MDC_HIGH(p_gmac)            (gpio_ioctl(p_gmac->mdc_pin, GPIO_VALUE_ATOMIC, 1, 0))
    #define HG_GMAC_MDC_LOW(p_gmac)             (gpio_ioctl(p_gmac->mdc_pin, GPIO_VALUE_ATOMIC, 0, 0))
    #define HG_GMAC_DELAY(p_gmac)               os_sleep_us(0)
#else
    #define HG_GMAC_MDIO_SET_OUTPUT(p_gmac)     HG_GMAC_REG_OPT((p_gmac)->hw->CSR9 |= BIT(18))
    #define HG_GMAC_MDIO_SET_INPUT(p_gmac)      HG_GMAC_REG_OPT((p_gmac)->hw->CSR9 &= ~BIT(18))
    #define HG_GMAC_MDIO_HIGH(p_gmac)           HG_GMAC_REG_OPT((p_gmac)->hw->CSR9 |= BIT(17))
    #define HG_GMAC_MDIO_LOW(p_gmac)            HG_GMAC_REG_OPT((p_gmac)->hw->CSR9 &= ~BIT(17))
    #define HG_GMAC_MDIO_GET(p_gmac)            ((p_gmac)->hw->CSR9 & BIT(19))
    #define HG_GMAC_MDC_HIGH(p_gmac)            HG_GMAC_REG_OPT((p_gmac)->hw->CSR9 |= BIT(16))
    #define HG_GMAC_MDC_LOW(p_gmac)             HG_GMAC_REG_OPT((p_gmac)->hw->CSR9 &= ~BIT(16))
    #define HG_GMAC_DELAY(p_gmac)               os_sleep_us(0)
#endif
