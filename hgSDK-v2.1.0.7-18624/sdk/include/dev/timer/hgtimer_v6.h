...
#define HGTIMER_V6_PWM_FUNC_CMD_INIT                          BIT(31) | 1
#define HGTIMER_V6_PWM_FUNC_CMD_DEINIT                        BIT(31) | 2
#define HGTIMER_V6_PWM_FUNC_CMD_START                         BIT(31) | 3
#define HGTIMER_V6_PWM_FUNC_CMD_STOP                          BIT(31) | 4
/* IOCTL CMD */                                        
#define HGTIMER_V6_PWM_FUNC_CMD_IOCTL_SET_PERIOD_DUTY         BIT(31) | 5
#define HGTIMER_V6_PWM_FUNC_CMD_IOCTL_SET_SINGLE_INCREAM      BIT(31) | 6
#define HGTIMER_V6_PWM_FUNC_CMD_IOCTL_SET_INCREAM_DECREASE    BIT(31) | 7

/* IRQ_FLAG */                                         
#define HGTIMER_V6_PWM_FUNC_CMD_REQUEST_IRQ_COMPARE           BIT(31) | 8
#define HGTIMER_V6_PWM_FUNC_CMD_REQUEST_IRQ_PERIOD            BIT(31) | 9

#define HGTIMER_V6_PWM_FUNC_CMD_RELEASE_IRQ                   BIT(31) | 10
