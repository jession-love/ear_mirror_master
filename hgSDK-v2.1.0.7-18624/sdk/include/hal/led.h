...
struct led_device {
    struct dev_obj dev;
    int32(*init)(struct led_device *led, enum led_work_mode work_mode, enum led_seg_cnt seg_cnt, enum led_com_cnt com_cnt);
    int32(*open)(struct led_device *led, uint32 num, enum led_com_cnt pos);
