...
struct capture_device {
    struct dev_obj dev;
    int32(*init)(struct capture_device *capture, enum capture_channel channel, enum capture_mode mode);
    int32(*deinit)(struct capture_device *capture, enum capture_channel channel);
    int32(*start)(struct capture_device *capture, enum capture_channel channel);
    int32(*stop)(struct capture_device *capture, enum capture_channel channel);
    int32(*ioctl)(struct capture_device *capture, enum capture_channel channel, enum capture_ioctl_cmd cmd, uint32 param1, uint32 param2);
    int32(*request_irq)(struct capture_device *capture, enum capture_channel channel, enum capture_irq_flag irq_flag, capture_irq_hdl irq_hdl, uint32 data);
    int32(*release_irq)(struct capture_device *capture, enum capture_channel channel);
};
