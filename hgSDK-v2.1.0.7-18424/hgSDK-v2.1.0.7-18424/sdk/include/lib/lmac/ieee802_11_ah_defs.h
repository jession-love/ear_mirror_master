...
struct ccmp_aad_pv0 {
    ...
    int16  seq_ctrl;
    uint8  a4[MAC_ADDR_SIZE];   // Optional
	int16  qos_ctrl;
};
...
struct ccmp_aad_pv1 {
    ...
    uint8  a2[MAC_ADDR_SIZE];
    int16  seq_ctrl;
    uint8  a3[MAC_ADDR_SIZE];  // Optional, depends on a3 present is SID
    uint8  a4[MAC_ADDR_SIZE];  // Optional, depends on a4 present is SID
};
