...
typedef void *(*audio_8311_set_buf)(void *priv_el,void *el_point,int *buf_size);
typedef void (*audio_8311_get_buf)(void *priv_el,void *el_point, int *buf_size);
...
typedef struct audio_8311_config
{
	//无需用户配置
	...
	int 	 buf_size;			
	audio_8311_set_buf set_buf;
	audio_8311_get_buf get_buf;
	void *priv_el;
